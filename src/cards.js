...
function Cards() {
    return (
        <div className="cards row justify-content-center">
            ...
            <section className="global-company  d-flex  justify-content-between col-8">
                    <div className="text col-3"> We are a global company <br></br>
                    with local culture</div>
                    <div className="icons col-8 row justify-content-between">
